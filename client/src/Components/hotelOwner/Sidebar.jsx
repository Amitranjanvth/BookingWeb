...
const Sidebar = () => {
  ...
  return (
    ...
    end={link.path === "/owner"} className={({ isActive }) => isActive ? 'flex items-center gap-3 px-4 py-3 bg-gray-200 text-gray-900 font-medium' : 'flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-100 hover:text-gray-900'}>
